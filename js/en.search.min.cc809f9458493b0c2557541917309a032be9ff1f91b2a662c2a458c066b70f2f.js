...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);loadScript('/public/js/groupBy-62b30ac391.min.js');loadScript('/public/js/flexsearch-ad47a5e1ee.min.js',function(){const indexCfg={};const dataUrl="/public/en.search-data.min.json"
